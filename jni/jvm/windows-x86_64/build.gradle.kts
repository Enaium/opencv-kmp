 ...
 * /cn/enaium/opencv/native/windows-x86_64/, which NativeLoader
...
JniModules.configure(project, "windows-x86_64")

mavenPublishing {
    coordinates(
        groupId = rootProject.group.toString(),
        artifactId = "opencv-kmp-jni-jvm-windows-x86_64",
    ...
    pom {
        name.set("opencv-kmp-jni-jvm-windows-x86_64")
        description.set(
            "Prebuilt JNI shared library for opencv-kmp on windows-x86_64. " +
