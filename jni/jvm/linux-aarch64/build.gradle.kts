 ...
 * /cn/enaium/opencv/native/linux-aarch64/, which NativeLoader
...
JniModules.configure(project, "linux-aarch64")

mavenPublishing {
    coordinates(
        groupId = rootProject.group.toString(),
        artifactId = "opencv-kmp-jni-jvm-linux-aarch64",
    ...
    pom {
        name.set("opencv-kmp-jni-jvm-linux-aarch64")
        description.set(
            "Prebuilt JNI shared library for opencv-kmp on linux-aarch64. " +
