 ...
 * /cn/enaium/opencv/native/darwin-x86_64/, which NativeLoader
...
JniModules.configure(project, "darwin-x86_64")

mavenPublishing {
    coordinates(
        groupId = rootProject.group.toString(),
        artifactId = "opencv-kmp-jni-jvm-darwin-x86_64",
    ...
    pom {
        name.set("opencv-kmp-jni-jvm-darwin-x86_64")
        description.set(
            "Prebuilt JNI shared library for opencv-kmp on darwin-x86_64. " +
