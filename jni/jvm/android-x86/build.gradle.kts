/*
 * Per-OS/arch JNI artifact: android-x86.
 * Ships libopencv_jni as a classpath resource at
 * /cn/enaium/opencv/native/android-x86/, which NativeLoader
...
JniModules.configure(project, "android-x86")

mavenPublishing {
    coordinates(
        groupId = rootProject.group.toString(),
        artifactId = "opencv-kmp-jni-jvm-android-x86",
    ...
    pom {
        name.set("opencv-kmp-jni-jvm-android-x86")
        description.set(
            "Prebuilt JNI shared library for opencv-kmp on android-x86. " +
