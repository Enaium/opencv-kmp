/*
 * Per-OS/arch JNI artifact: android-arm64-v8a.
 * Ships libopencv_jni as a classpath resource at
 * /cn/enaium/opencv/native/android-arm64-v8a/, which NativeLoader
...
JniModules.configure(project, "android-arm64-v8a")

mavenPublishing {
    coordinates(
        groupId = rootProject.group.toString(),
        artifactId = "opencv-kmp-jni-jvm-android-arm64-v8a",
    ...
    pom {
        name.set("opencv-kmp-jni-jvm-android-arm64-v8a")
        description.set(
            "Prebuilt JNI shared library for opencv-kmp on android-arm64-v8a. " +
