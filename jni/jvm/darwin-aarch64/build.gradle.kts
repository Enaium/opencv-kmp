 ...
 * /cn/enaium/opencv/native/darwin-aarch64/, which NativeLoader
...
JniModules.configure(project, "darwin-aarch64")

mavenPublishing {
    coordinates(
        groupId = rootProject.group.toString(),
        artifactId = "opencv-kmp-jni-jvm-darwin-aarch64",
    ...
    pom {
        name.set("opencv-kmp-jni-jvm-darwin-aarch64")
        description.set(
            "Prebuilt JNI shared library for opencv-kmp on darwin-aarch64. " +
