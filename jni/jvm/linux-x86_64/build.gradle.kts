 ...
 * /cn/enaium/opencv/native/linux-x86_64/, which NativeLoader
...
JniModules.configure(project, "linux-x86_64")

mavenPublishing {
    coordinates(
        groupId = rootProject.group.toString(),
        artifactId = "opencv-kmp-jni-jvm-linux-x86_64",
    ...
    pom {
        name.set("opencv-kmp-jni-jvm-linux-x86_64")
        description.set(
            "Prebuilt JNI shared library for opencv-kmp on linux-x86_64. " +
